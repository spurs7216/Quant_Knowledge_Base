...
- controller-safe is not the same as execution-effective: signal/ranking edits must affect ranked signals or final weights, while portfolio/risk edits must affect final weights or exposure shape after downstream controls;

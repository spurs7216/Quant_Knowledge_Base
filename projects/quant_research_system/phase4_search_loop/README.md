...
- [phase4_caveat_repair_ledger.md](phase4_caveat_repair_ledger.md): active ledger of plan-level caveats, repairs, and remaining constraints before remote generation runs.
...
- [expression_episode_remote_instructions_20260526.md](expression_episode_remote_instructions_20260526.md): completed remote handoff for the first Qwen-backed JSON-expression episode using the reviewed seed-zoo parents and fixed daily-stock evaluator contracts.
- [expression_episode_20260526_review.md](expression_episode_20260526_review.md): reviewed the first population-aware expression episode; no primary-bridge child is promotable, but a smoothed-reversal liquidity child warrants bridge-policy follow-up.
- [expression_bridge_followup_remote_instructions_20260526.md](expression_bridge_followup_remote_instructions_20260526.md): current deterministic remote handoff for parent-vs-child bridge-policy comparison. This run does not call Qwen and cannot promote a strategy by itself.
- [expression_bridge_followup_review_20260526.md](expression_bridge_followup_review_20260526.md): reviewed bridge follow-up; `rebalance_5` passes the follow-up rule, but evidence is cost- and phase-sensitive, so the next step is deterministic bridge robustness before strategy conversion.
- [expression_bridge_robustness_remote_instructions_20260526.md](expression_bridge_robustness_remote_instructions_20260526.md): current deterministic remote handoff for rebalance phase/period robustness. This run does not call Qwen and cannot promote a strategy by itself.
